...
<%@taglib prefix="shiroRest" uri="http://www.springsecurity.org/jsp" %>
...
<%--									   <i class="glyphicon glyphicon-chevron-right"></i>权限分配1--%>
<%--								   </a>--%>
<%--							   </li>--%>
<%--						   </shiro:hasPermission>--%>
							<shiroRest:authorize buttonUrl="/permission/allocation.shtml" buttonMethod="GET">
								<li class="  dropdown">
									<a href="<%=basePath%>/permission/allocation.shtml">
										<i class="glyphicon glyphicon-chevron-right"></i>权限分配12
									</a>
								</li>
							</shiroRest:authorize>
						</ul>
